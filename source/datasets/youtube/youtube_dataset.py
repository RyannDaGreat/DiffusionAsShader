...
class ProcessedYoutubeGsSample(GsSample):
    ...
    @cached_property
    def prompt(self):
        return self.load_file('prompt.txt')
    
    @cached_property
    def video(self):
        return self.load_file('video.mp4')
    
    @cached_property
    def cogxCounterVideo(self):
        """ The counterfactual video generated by CogVideoX with my inpainting model """
        return self.load_file('firstLastInterp_Jack2000.mp4')

    @cached_property
    def video_dasTrackvid(self):
        """ The Diffusion-as-Shader 3d Point Tracking Video """
        return self.load_file('video.mp4__DiffusionAsShaderCondition/tracking_video.mp4')
    
    @cached_property
    def cogxCounterVideo_dasTrackvid(self):
        """ The Diffusion-as-Shader 3d Point Tracking Video for the counterfactual video"""
        return self.load_file('firstLastInterp_Jack2000.mp4__DiffusionAsShaderCondition/tracking_video.mp4')
